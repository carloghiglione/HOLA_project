...
class Hyperparameters:
    def __init__(self, transition_prob_listofmatrix, dir_params_listofvector, pois_param_vector, conversion_rate_listofmatrix, margin_matrix, mean_extra_purchases_per_product=2*np.ones(shape=5)):
